...
const FeaturedListings = () => {
  ...
  const featuredListings = (() => {
    ...
    const discountedListings = listings
      .filter(listing => !listing.featured && (listing.discounted_price || listing.discount_value))
      .sort((a, b) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {featuredListings.map((listing, index) => {
            ...
            return (
              <Card key={listing.id} className="overflow-hidden card-shadow hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 animate-fade-in cursor-pointer" style={{
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  {listing.usp && (
                    <div className="mb-3 sm:mb-4">
                      <span className="text-xs sm:text-sm text-adventure-orange font-medium">
                        {listing.usp}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <div>
                      ...
                      <div className="text-xs sm:text-sm text-gray-600">per {listing.pricing_unit || 'month'}</div>
                    </div>
                  </div>
