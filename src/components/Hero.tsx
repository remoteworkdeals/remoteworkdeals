          ...
          <div className="animate-fade-in text-center lg:text-left">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 text-sm">
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-adventure-orange">2,847</div>
                <div className="text-xs sm:text-sm">Community Members</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl font-bold text-adventure-orange">147</div>
                <div className="text-xs sm:text-sm">Partner Locations</div>
              </div>
              <div className="text-center">
              ...
              <div className="grid gap-3 sm:gap-4 md:grid-cols-3">
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-10 h-11 sm:h-12 border-0 text-gray-800 text-base sm:text-lg"
                  />
                </div>
                <Select>
                ...
                <Button 
                  className="adventure-button h-11 sm:h-12 text-base sm:text-lg w-full"
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Button 
                className="adventure-button text-base sm:text-lg py-3 sm:py-4 px-6 sm:px-8 w-full sm:w-auto"
              ...
              <Button 
                variant="outline" 
                className="outline-button text-base sm:text-lg py-3 sm:py-4 px-6 sm:px-8 bg-transparent border-white text-white hover:bg-white hover:text-forest-green w-full sm:w-auto"
                onClick={() => navigate('/coliving-deals')}
              >
                Browse All Deals
              </Button>
