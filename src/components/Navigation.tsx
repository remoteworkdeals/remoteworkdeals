            ...
            <form onSubmit={handleSearch} className="relative">
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-4 py-2 w-64 border-gray-300 focus:border-forest-green focus:ring-forest-green"
                />
              </div>
            </form>
              ...
              <form onSubmit={handleSearch} className="mb-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    className="pl-10 pr-4 py-2 w-full border-gray-300 focus:border-forest-green focus:ring-forest-green"
                  />
                </div>
              </form>
