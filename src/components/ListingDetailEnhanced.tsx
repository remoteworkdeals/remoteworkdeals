...
import ReviewsSectionEnhanced from './ReviewsSectionEnhanced';
import ReviewForm from './ReviewForm';

interface ListingDetailEnhancedProps {
  listingId: number;
}

const ListingDetailEnhanced = ({ listingId }: ListingDetailEnhancedProps) => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8">
      ...
      {/* Reviews Section */}
      <ReviewsSectionEnhanced reviews={reviews} />
